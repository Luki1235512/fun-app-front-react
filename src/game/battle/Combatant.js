...
export class Combatant {
    ...
    `)
        ...
        this.standElement = document.createElement("img")
        this.standElement.classList.add("Stand")
        this.standElement.setAttribute("src", this.src)
    ...
    init(container) {
        ...
        container.appendChild(this.standElement)
        this.update()
    }
}
